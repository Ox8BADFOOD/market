...
class GoodsChannelGroup(BaseModel):
    """商品频道组"""
    name = models.CharField(max_length=20, verbose_name='商品频道')
...
class GoodsChannel(BaseModel):
    """商品频道"""
    group = models.ForeignKey(to=GoodsChannelGroup, on_delete=models.CASCADE, verbose_name='频道组名')
    category = models.ForeignKey(to=GoodsCategory, on_delete=models.CASCADE, verbose_name='顶级商品类别')
...
class GoodsVisitCount(BaseModel):
    """统计分类商品访问量模型类"""
    category = models.ForeignKey(to=GoodsCategory, on_delete=models.CASCADE, verbose_name='商品分类')
