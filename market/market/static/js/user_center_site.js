let vm = new Vue({
    ...
    watch: {
        // 监听到省份id变化
        'form_address.province_id': function(val, oldVal){
    ...
    methods: {
        ...
        show_edit_site(index){
            ...
            // 只获取要编辑的数据
            const temp_address = JSON.parse(JSON.stringify(this.addresses[index]));
            this.form_address = temp_address;
        },
        // 校验收货人
        check_receiver(){
        ...
        select_province(e){
            const province = this.provinces[e.target.selectedIndex];
            this.form_address.province_id = String(province.id);
            this.form_address.cite = null
            this.form_address.city_id = null
            this.form_address.district = null
            this.form_address.district_id = null
        },
        select_city(e){
            const city = this.cities[e.target.selectedIndex];
            this.form_address.city_id = city.id;
            this.form_address.district = null
            this.form_address.district_id = null
        },
        select_district(e){
            const district = this.districts[e.target.selectedIndex];
